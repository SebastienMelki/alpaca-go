...
const file_alpaca_trading_v1_portfolio_history_proto_rawDesc = "" +
	"\n" +
	")alpaca/trading/v1/portfolio_history.proto\x12\x11alpaca.trading.v1\x1a\x1csebuf/http/annotations.proto\"\xee\x01\n" +
	"\x10PortfolioHistory\x12\"\n" +
	"\ttimestamp\x18\x01 \x03(\x03B\x04е\x18\x02R\ttimestamp\x12\x16\n" +
