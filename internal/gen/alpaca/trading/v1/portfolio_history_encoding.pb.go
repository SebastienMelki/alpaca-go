...
// UnmarshalJSONSebuf implements sebufUnmarshaler for PortfolioHistory.
// This method handles int64_encoding=NUMBER fields: timestamp
func (x *PortfolioHistory) UnmarshalJSONSebuf(data []byte, opts protojson.UnmarshalOptions) error {
