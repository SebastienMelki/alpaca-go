...
const file_alpaca_broker_v1_service_proto_rawDesc = "" +
	...
	"\x03/v1\xaa\xb5\x18s\n" +
	"q\n" +
	"\rAuthorization\x126HTTP Basic Auth with base64 encoded API_KEY:API_SECRET\x1a\x06string \x012\x1eBasic QVBJLUtFWTpBUEktU0VDUkVUB\xc9\x01\n" +
	"\x14com.alpaca.broker.v1B\fServiceProtoP\x01ZAgithub.com/sebastienmelki/alpaca-go/api/alpaca/broker/v1;brokerv1\xa2\x02\x03ABX\xaa\x02\x10Alpaca.Broker.V1\xca\x02\x10Alpaca\\Broker\\V1\xe2\x02\x1cAlpaca\\Broker\\V1\\GPBMetadata\xea\x02\x12Alpaca::Broker::V1b\x06proto3"
